...
//                 Your agent can talk to other passenger agents on the same flight, share information, and coordinate actions.
//               </p>
...
//               >
//                 Get boarding pass for your AI Agent
//               </button>
              
//               <h3 className="text-xs text-gray-500 mt-2">Muqeet on flight</h3>
//             </div>
            
//             {isAgentModalOpen && (
//               <AgentModal 
//                 planeId={flight.icao24} 
//                 onClose={() => setIsAgentModalOpen(false)}
//               />
//             )}
            
//             <ChatPanel planeId={flight.icao24} />
//           </div>
//         )}
//       </div>

//       <h1 className="text-xs text-gray-500 mt-2">Muqeet on flight</h1>
//     </div>
//   );
// }
...
export default function FlightInfoCard({ flight, onClose }: FlightInfoCardProps) {
  ...
  return (
    <div className="fixed right-4 top-4 bottom-4 w-96 bg-black/20 backdrop-blur-md rounded-lg shadow-2xl flex flex-col z-50 overflow-hidden border border-white/10">
      ...
      <h1 className="text-xs text-gray-500 mt-2 p-2">Muqeet on flight</h1>
    </div>
  );
}