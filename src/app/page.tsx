...
export default function MapPage() {
  // Pass bbox if you want to filter by region
  const { flights, connected } = useFlights({ bbox: '-43.6,113.0,-10.0,154.0' });

  return (
    <>
      {!connected && (
        <div className="absolute top-2 left-2 z-10 bg-yellow-500 text-black px-3 py-1 rounded text-sm">
          ⚡ Reconnecting...
        </div>
      )}
      <Map>
